...
lira(x_u = y_u, x_v = y_v, num_ratings = d) # 1.431364
...
lira(x_u = y_u, x_v = y_v, num_ratings = 5) # 1.19381
...
lira(x_u = y_u, x_v = y_v, num_ratings = 5) # 2.38764
...
lira(x_u = y_u, x_v = y_v, num_ratings = 5) # 0.5814601 - small similarity
